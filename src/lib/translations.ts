...
const footer: FooterTranslations = {
    ...
    navLinks: {
        tr: ["Ana Sayfa", "Genel Bakış", "Özellikler", "Teknoloji", "Silahlar", "Motor", "Üretim"],
        en: ["Home", "Overview", "Specs", "Technology", "Weapons", "Engine", "Production"],
    },
...
const timeline: Record<Locale, { sectionTag: string; title: string; titleAccent: string; milestones: Milestone[] }> = {
    tr: {
        ...
        milestones: [
            ...
            { year: "2026", title: "P1 Prototipi İlk Uçuş", description: "Haziran 2026'da P1 uçuş prototipi ilk uçuşunu gerçekleştirecek. P2 prototipi yıl sonunda testlere katılacak." },
            { year: "2027", title: "P3 Prototipi & Test Genişlemesi", description: "Üçüncü prototip (P3) uçuş testlerine başlayacak. Silah sistemi entegrasyon testleri yoğunlaşacak." },
            { year: "2028-29", title: "Seri Üretim Başlangıcı (Blok 10)", description: "İlk seri üretim uçakları (Blok 10) Türk Hava Kuvvetleri'ne teslim edilecek. GE F110 motorlu konfigürasyon." },
            { year: "2030+", title: "Blok 20 & İhracat", description: "Geliştirilmiş Blok 20 üretimi. Endonezya başta olmak üzere ihracat teslimatları başlayacak." },
            { year: "2032", title: "Yerli Motor Entegrasyonu", description: "TEI TF35000 yerli motorun KAAN'a entegrasyonu tamamlanacak. Blok 30 ile tam bağımsız savunma yeteneği." },
        ],
    },
    en: {
        ...
        milestones: [
            ...
            { year: "2026", title: "P1 Prototype First Flight", description: "P1 flight prototype will conduct its maiden flight in June 2026. P2 prototype will join testing by year-end." },
            { year: "2027", title: "P3 Prototype & Test Expansion", description: "Third prototype (P3) will begin flight testing. Weapons system integration tests will intensify." },
            { year: "2028-29", title: "Serial Production Start (Block 10)", description: "First serial production aircraft (Block 10) delivered to Turkish Air Force. GE F110 engine configuration." },
            { year: "2030+", title: "Block 20 & Export", description: "Enhanced Block 20 production begins. Export deliveries commence, led by Indonesia." },
            { year: "2032", title: "Indigenous Engine Integration", description: "TEI TF35000 indigenous engine integration with KAAN completed. Block 30 achieves full defense independence." },
        ],
    },
};
