...
const t = {
    tr: {
        ...
        companies: [
            ...
            { role: "Aviyonik & Sensör Sistemleri" },
            { role: "Roket & Seyir Füzeleri" },
            { role: "Motor Geliştirme" },
            { role: "Ana Bilgisayar & Akıllı Mühimmat" },
            { role: "Simülasyon & Eğitim Sistemleri" },
        ],
        companyProducts: [
            ["KAAN", "ANKA-3", "HÜRJET", "Süper Şimşek"],
            ["MURAD AESA", "TOLUN", "KARAT / TOYGUN", "EW Paketi"],
            ["SOM-J", "ÇAKIR", "MAM-T", "TEBER"],
            ["TF-35000", "TF-10000", "TS-1400"],
            ["Uçuş Bilgisayarı (BİLGEM)", "GÖKDOĞAN (SAGE)", "BOZDOĞAN (SAGE)", "HGK / KGK (SAGE)"],
            ["Uçuş Simülatörü", "Gömülü Eğitim Sistemi", "Yer Kontrol İstasyonu"],
        ],
    ...
    en: {
        ...
        companies: [
            ...
            { role: "Avionics & Sensor Systems" },
            { role: "Rockets & Cruise Missiles" },
            { role: "Engine Development" },
            { role: "Main Computer & Smart Munitions" },
            { role: "Simulation & Training Systems" },
        ],
        companyProducts: [
            ["KAAN", "ANKA-3", "HÜRJET", "Süper Şimşek"],
            ["MURAD AESA", "TOLUN", "KARAT / TOYGUN", "EW Suite"],
            ["SOM-J", "ÇAKIR", "MAM-T", "TEBER"],
            ["TF-35000", "TF-10000", "TS-1400"],
            ["Flight Computer (BİLGEM)", "GÖKDOĞAN (SAGE)", "BOZDOĞAN (SAGE)", "HGK / KGK (SAGE)"],
            ["Flight Simulator", "Embedded Training System", "Ground Control Station"],
        ],
