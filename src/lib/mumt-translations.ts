...
const t = {
    tr: {
        ...
        companies: [
            ...
            { role: "Roket & Füze Üretimi" },
            { role: "Motor Geliştirme" },
            { role: "Füze & Mühimmat Tasarımı" },
            { role: "Simülasyon & Görev Sistemleri" },
        ],
        companyProducts: [
            ["KAAN", "ANKA-3", "HÜRJET", "Süper Şimşek"],
            ["MURAD AESA", "TOLUN", "IVDL", "EW Paketi"],
            ["SOM (Üretim)", "Cirit", "UMTAS", "HİSAR"],
            ["TF-10000", "TF-35000", "TS-1400"],
            ["GÖKDOĞAN", "BOZDOĞAN", "SOM (Tasarım)", "GÖKHAN"],
    ...
    en: {
        ...
        companies: [
            ...
            { role: "Rocket & Missile Production" },
            { role: "Engine Development" },
            { role: "Missile & Munition Design" },
            { role: "Simulation & Mission Systems" },
        ],
        companyProducts: [
            ["KAAN", "ANKA-3", "HÜRJET", "Süper Şimşek"],
            ["MURAD AESA", "TOLUN", "IVDL", "EW Suite"],
            ["SOM (Production)", "Cirit", "UMTAS", "HİSAR"],
            ["TF-10000", "TF-35000", "TS-1400"],
            ["GÖKDOĞAN", "BOZDOĞAN", "SOM (Design)", "GÖKHAN"],
